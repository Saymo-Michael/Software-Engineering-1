...
const GridLayout = () => {
  ...
  return (
    <Container Container fluid className="d-flex flex-column min-vh-100 p-0 m-0">
      ...
      <Row className="d-flex flex-grow-1 p-0 m-0">
        ...
        <Col lg={4} md={6} xs={12} className="d-flex flex-column flex-grow-1 p-0 m-0">
          ...
          <Row>
            <Col md={6} className={clsx(Style.square, Style.square5, "p-0 m-0")}>About Us</Col>
          </Row>
        </Col>

        {/* Right side - Single merged row */}
        <Col md={6} className={clsx(Style.square, Style.square6, "p-0 m-0")}>6</Col>
      </Row>

      {/* Third Row - 2 Equal Columns */}
      <Row>
        <Col md={6} className={clsx(Style.square, Style.square7, "p-0 m-0")}>7</Col>
        <Col md={6} className={clsx(Style.square, Style.square8, "p-0 m-0")}>8</Col>
      </Row>
    </Container>
  );
};
